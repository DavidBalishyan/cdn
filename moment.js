...
!(function (e, t) {
  ...
  function Te(e, t) {
    return function (s) {
      return null != s
        ? (Ne(this, e, s), n.updateOffset(this, t), this)
        : xe(this, e);
    };
  }
  function xe(e, t) {
  ...
  function We(e, t) {
    ...
    var n,
      s = ((t % (n = 12)) + n) % n;
    return (
      (e += (t - s) / 12), 1 === s ? (_e(e) ? 29 : 28) : 31 - ((s % 7) % 2)
    );
  }
  ...
  function Le(e, t) {
    ...
    var n = t,
      s = e.date();
    return (
      (s = s < 29 ? s : Math.min(s, We(e.year(), n))),
  ...
  function Ve(e) {
    return null != e
      ? (Le(this, e), n.updateOffset(this, !0), this)
      : xe(this, "Month");
  }
  function Ge() {
    function e(e, t) {
  ...
  function tt() {
    ...
    for (t = 0; t < 7; t++)
      (n = c([2e3, 1]).day(t)),
        (s = ue(this.weekdaysMin(n, ""))),
        (i = ue(this.weekdaysShort(n, ""))),
        (r = ue(this.weekdays(n, ""))),
        a.push(s),
        o.push(i),
        u.push(r),
        l.push(s),
  ...
  function _t(e) {
    ...
    return (function (e) {
      for (var t, n, s, i, r = 0; r < e.length; ) {
        for (
          t = (i = ht(e[r]).split("-")).length,
            n = (n = ht(e[r + 1])) ? n.split("-") : null;
          t > 0;
    ...
    return (
      n &&
        ...
        ((t =
          n[ge] < 0 || n[ge] > 11
            ? ge
            : n[we] < 1 || n[we] > We(n[ye], n[ge])
            ? we
            : n[pe] < 0 ||
              n[pe] > 24 ||
              (24 === n[pe] && (0 !== n[ve] || 0 !== n[ke] || 0 !== n[Me]))
            ? pe
            : n[ve] < 0 || n[ve] > 59
            ? ve
            : n[ke] < 0 || n[ke] > 59
            ...
            (function (e) {
              ...
              (t = e._w),
                null != t.GG || null != t.W || null != t.E
                  ? ((r = 1),
                    (a = 4),
                    (n = Tt(t.GG, e._a[ye], Ze(Rt(), 1, 4).year)),
                    (s = Tt(t.W, 1)),
                    ((i = Tt(t.E, 1)) < 1 || i > 7) && (u = !0))
                  : ((r = e._locale._week.dow),
                    (a = e._locale._week.doy),
                    (l = Ze(Rt(), r, a)),
                    (n = Tt(t.gg, e._a[ye], l.year)),
                    (s = Tt(t.w, l.week)),
                    null != t.d
                      ? ((i = t.d) < 0 || i > 6) && (u = !0)
                      : null != t.e
        ...
        for (
          ...
          (r = i[t]),
            (s = (l.match(oe(r, e)) || [])[0]) &&
              ...
              (h += s.length)),
            R[r]
              ? (s ? (f(e).empty = !1) : f(e).unusedTokens.push(r), me(r, s, e))
  ...
  function Pt(e, t, n, r, o) {
    ...
    return (
      ...
      (l._f = t),
      (l._strict = r),
      (u = new p(yt(Wt(l))))._nextDay && (u.add(1, "d"), (u._nextDay = void 0)),
      u
    );
  }
  function Rt(e, t, n, s) {
  ...
  function Lt(e) {
    ...
    (this._isValid = (function (e) {
      var t,
        ...
        i = Ft.length;
      for (t in e)
        if (r(e, t) && (-1 === Oe.call(Ft, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
      for (n = 0; n < i; ++n)
        if (e[Ft[n]]) {
          if (s) return !1;
  ...
  function It(e, t) {
    ...
    return t._isUTC
      ? ((s = t.clone()),
        (i = (v(e) || l(e) ? e.valueOf() : Rt(e).valueOf()) - s.valueOf()),
  ...
  function Kt(e, t, s, i) {
    ...
    e.isValid() &&
      ((i = null == i || i),
      o && Le(e, xe(e, "Month") + o * s),
      a && Ne(e, "Date", xe(e, "Date") + a * s),
  ...
  (bn.add = en),
    ...
    (bn.endOf = function (e) {
      ...
      switch (((s = this._isUTC ? _n : mn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t +=
              hn - fn(t + (this._isUTC ? 0 : this.utcOffset() * dn), hn) - 1);
          break;
        case "minute":
    ...
    (bn.from = function (e, t) {
      return this.isValid() && ((v(e) && e.isValid()) || Rt(e).isValid())
    ...
    (bn.startOf = function (e) {
      ...
      switch (((s = this._isUTC ? _n : mn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t -= fn(t + (this._isUTC ? 0 : this.utcOffset() * dn), hn));
          break;
        case "minute":
    ...
    (bn.hasAlignedHourOffset = function (e) {
      return (
        !!this.isValid() &&
        ((e = e ? Rt(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }),
    (bn.isDST = function () {
      return (
    ...
    (bn.months = M("months accessor is deprecated. Use month instead", Ve)),
    (bn.years = M("years accessor is deprecated. Use year instead", be)),
    (bn.zone = M(
  ...
  (xn.calendar = function (e, t, n) {
    ...
    (xn.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (r(this, "_monthsRegex") || Ge.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : (r(this, "_monthsRegex") || (this._monthsRegex = He),
    ...
    (xn.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (r(this, "_monthsShortRegex") || (this._monthsShortRegex = Ue),
  ...
  function us() {
    ...
    return h
      ? ((e = le(u / 60)),
        ...
        (i = h < 0 ? "-" : ""),
        (r = os(this._months) !== os(h) ? "-" : ""),
        (a = os(this._days) !== os(h) ? "-" : ""),
        (o = os(this._milliseconds) !== os(h) ? "-" : ""),
        i +
          "P" +
          (n ? r + n + "Y" : "") +
          (d ? r + d + "M" : "") +
  ...
  return (
    ...
    (n.relativeTimeThreshold = function (e, t) {
      return (
        void 0 !== is[e] &&
        (void 0 === t ? is[e] : ((is[e] = t), "s" === e && (is.ss = t - 1), !0))
      );
    }),
